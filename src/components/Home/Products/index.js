...
import { Row, Pagination, FloatButton, Input, Card, Typography, Space, Rate, Button } from 'antd';
        ...
        <Space direction="vertical">
            <Card bodyStyle={styleBodyCardInputSearch} style={styleCardInputSearch}>
                <Space size={20} align="center">
                    <p>Sắp xếp theo</p>
                    <Button onClick={handleClickOrderSoldCount} type={searchParam.isOrderSoldCount ? "primary" : "default"}>Bán chạy</Button>
